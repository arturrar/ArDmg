/*!
	\brief  Код для лабораторной работы
	\author ArDmg
	\version 1.0
	\warning Код создан чисто в учебных целях

	Программа которая читает с файлов 2 матрицы и может выполнять 3 вида операций дан ними: сложение, вычитание, умножения. Написано на языке GO.
*/
